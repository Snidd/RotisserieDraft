...
var CSS_TAG = "mtgcard";
var CSS_TAG_ALTERNATIVE = "alternative-link"
var CARD_HEIGHT = 310;
var CARD_WIDTH = 220;
var BORDER_WIDTH = 13;
var body;
...
function addMouseOverLinks() {
    ...
    for (var i = 0; i < cardLinks.length; i++) {
        ...
        if (elem.className.startsWith(CSS_TAG) || elem.className.startsWith(CSS_TAG_ALTERNATIVE) || elem.href.indexOf(URL_START) != -1 || elem.href.indexOf(URL_START_IMG) != -1) {
